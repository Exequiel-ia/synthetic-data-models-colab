...
import pandas as pd
import time
from vendor.ctabgan_model.pipeline.data_preparation import DataPrep
from vendor.ctabgan_model.synthesizer.ctabgan_synthesizer import CTABGANSynthesizer
...
class CTABGAN():
    ...
    def __init__(self,
        ...
        self.synthesizer = CTABGANSynthesizer(batch_size=batch_size, epochs=epochs)
